...
public class ResponeResult {
     ...
     * @return
     */
    public static ResponeResult formatToPojo(String jsonData, Class<?> clazz) {
        try {
            if (clazz == null) {
                return MAPPER.readValue(jsonData, ResponeResult.class);
            }
     ...
     * @return
     */
    public static ResponeResult format(String json) {
        try {
            return MAPPER.readValue(json, ResponeResult.class);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return null;
     ...
     * @return
     */
    public static ResponeResult formatToList(String jsonData, Class<?> clazz) {
        try {
            JsonNode jsonNode = MAPPER.readTree(jsonData);
            JsonNode data = jsonNode.get("data");
            Object obj = null;
